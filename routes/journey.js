...
router.get("/getAllJourneys", authMiddleware, async (req, res) => {
  try {
    const journeys = await Journey.find({ isDeleted: false })
      .populate("bus", "-createdAt -updatedAt -__v -createdBy -updatedBy -isDeleted")
      .populate("tax", "-createdAt -updatedAt -__v -createdBy -updatedBy -isDeleted")
      .populate("coupon", "-createdAt -updatedAt -__v -createdBy -updatedBy -isDeleted")
...
router.patch("/updateJourney/:id", employeeMiddleware, async (req, res) => {
  try {
